...
class TaskProcedure extends BaseProcedure
{
  ...
  public function getTaskByAddress($project_id, $address)
    {
        ProjectAuthorization::getInstance($this->container)->check($this->getClassName(), 'getTaskByAddress', $project_id);
        $task = $this->taskFinderModel->getByAddress($project_id, $address);
        return $this->taskApiFormatter->withTask($task)->format();
    }
    public function getTaskByCity($project_id, $city)
    {
        ProjectAuthorization::getInstance($this->container)->check($this->getClassName(), 'getTaskByCity', $project_id);
        $task = $this->taskFinderModel->getByCity($project_id, $city);
        return $this->taskApiFormatter->withTask($task)->format();
    }
    ...
    public function createTask($title, $project_id, $color_id = '', $column_id = 0, $owner_id = 0, $creator_id = 0,
                               ...
                               $recurrence_basedate = 0, $reference = '', $address= '',$city= '',array $tags = array(), $date_started = '',
    ...
    public function updateTask($id, $title = null, $color_id = null, $owner_id = null,
                               ...
                               $recurrence_timeframe = null, $recurrence_basedate = null, $reference = null, $address= null,$city=null, $tags = null, $date_started = null,
                               $time_spent = null, $time_estimated = null)
    {
