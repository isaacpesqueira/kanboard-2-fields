<div class="task-list-icons">
    ...
    <?php endif ?>
     ...
     <?php if ($task['address']): ?>
        <span class="task-board-reference" title="<?= t('Address') ?>">
            <span class="ui-helper-hidden-accessible"><?= t('Address') ?> </span><?= $this->task->renderAddress($task) ?>
        </span>
    <?php endif ?>

    <?php if ($task['city']): ?>
        <span class="task-board-reference" title="<?= t('City') ?>">
            <span class="ui-helper-hidden-accessible"><?= t('City') ?> </span><?= $this->task->renderCity($task) ?>
        </span>
    <?php endif ?>
